...
export const FAQSection = () => {
  return (
    <section id="faq" className="grid gap-8 rounded-3xl border border-border/60 bg-card/70 p-8 shadow-md md:grid-cols-[2fr_3fr] md:p-12">
      ...
      <Accordion type="single" collapsible className="space-y-4">
        {FAQ_ITEMS.map((item, index) => (
          <AccordionItem key={item.question} value={`faq-${index}`} className="rounded-2xl border border-border/60 bg-background/70 px-4">
